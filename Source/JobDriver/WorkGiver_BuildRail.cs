...
{
    internal class WorkGiver_BuildRail : WorkGiver_Scanner
    {
        public override IEnumerable<Thing> PotentialWorkThingsGlobal(Pawn pawn)
        {
            if (pawn.Spawned && pawn.Map != null)
            {
                ...
                {
                    if (station.currentTunnel != null && station.currentTunnel.IsFinished() && station.GetFirstRailToBuild() != null)
                    {
        ...
        {
            return JobMaker.MakeJob(FunctionalTrainsDefOf.FT_JobBuildRail, t, 1500, true);
        }
    }
}
